...
async def alive(client: Client, message):
    ...
    alive = f"""╭──── • ◈ • ────╮
么 [𝑫𝒆𝒗 𝒔𝒐𝒖𝒓𝒄𝒆](https://t.me/Almortagel_12).
么 [𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆](https://t.me/AlmortagelTech).
么 [𝑮𝒓𝒐𝒖𝒑 𝒔𝒐𝒖𝒓𝒄𝒆](https://t.me/AlmortagelTech2).
╰──── • ◈ • ────╯
...
@Client.on_message(filters.command(["المطور المرتجل","المرتجل","المبرمج"], ""))
