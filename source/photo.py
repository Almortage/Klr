...
async def sssora(client, message):
  ...
  await message.reply_photo(photo=photo, caption="**𝑱𝒐𝒊𝒏 ➧ @AlmortagelTech .**")
...
async def voece(client, message):
  ...
  await message.reply_audio(audio=audio, caption="**𝑱𝒐𝒊𝒏 ➧ @AlmortagelTech .**")
...
async def videoo(client, message):
  ...
  await message.reply_video(video=video, caption="**𝑱𝒐𝒊𝒏 ➧ @AlmortagelTech .**")
